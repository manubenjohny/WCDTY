...
switch opt
    case 2        
       ...
       if mCDI.flag >0
            mCDI.flag = 0;
            set(HGUI(23),'BackgroundColor',  [7.5294e-001  7.5294e-001  7.5294e-001])
...
global datafilepath datafilename HFmain mCDI;
Finfo = get(HFmain,'UserData');
HGUI = 	 Finfo(1,:);			% GUI Handles
    mCDI.flag = 1;    
    set(HGUI(23),'BackgroundColor',  [4e-001  4e-001  4e-001])
%%  user input    
    emptyCat = 0;
